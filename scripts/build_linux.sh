...
clipackagereporter.cpp dockitem.cpp tarzipper.cpp ./luajit/src/libluajit.a \
-I./luajit/src -I./stlsoft-1.9.116/include -I./sfml/include -L./sfml-lib \
-lsfml-graphics -lsfml-window -lsfml-system -ldl -o bbmain
