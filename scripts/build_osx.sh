...
make
cd ..
g++ bbsfmlmain.cpp bbutil.cpp gfxmanager.cpp circle2d.cpp line2d.cpp \
point2d.cpp sensorhandler.cpp zone.cpp bbengine.cpp bblua.cpp \
...
-pagezero_size 10000 -image_base 100000000 -o bbmain
