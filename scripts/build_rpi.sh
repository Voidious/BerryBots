...
point2d.cpp circle2d.cpp rectangle.cpp zone.cpp bbpigfx.cpp \
gfxeventhandler.cpp sensorhandler.cpp cliprinthandler.cpp libshapes.c \
oglinit.c ./luajit/src/libluajit.a -I./luajit/src -I./stlsoft-1.9.116/include \
