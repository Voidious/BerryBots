...
NewMatchDialog::NewMatchDialog(NewMatchListener *listener,
  ...
  dirsBorderSizer->Add(dirsSizer);
  gridSizer->Add(dirsBorderSizer, 0, wxALIGN_LEFT | wxALIGN_TOP);
